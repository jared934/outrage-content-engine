-- =============================================================================
-- OUTRAGE Content Engine — Migration 003: Seed Data
-- Version: 1.0.0
-- Description: Default org, pipeline stages, brand settings, RSS sources,
--              alert rules, meme templates, prompt templates, competitor
--              watchlist, tags, and workflows.
-- Run AFTER 002_rls_policies.sql. Uses service_role or direct DB access.
-- =============================================================================
